...
export class LobbyScene extends Phaser.Scene {
    ...
    public create(): void {
        ...
        let title = new Phaser.GameObjects.Image(this, 0, 10, "texture_atlas_1", "logo_title");
        title.setOrigin(.5, 0);
        this.topContainer.add(title);

        let powered = new Phaser.GameObjects.Text(this, 0, 110, " powered by Cartesi ", {fontFamily: "Oswald-Medium", fontSize: "20px", color: "#FFFFFF"});
