...
const defaultGameTemplateHash = "0x160bab456d22ffa5964e25064a928861816cfc724f5c30b583a0993917b1ddeb";
...
// LIST-COUPONS
task("list-coupons", "Lists coupons redeemed from the PokerTokenFaucet").setAction(async ({ count, length }, hre) => {
    const { ethers } = hre;
